...
def main():
    ...
    model_dir = './saved_models/' + dataset_name+'/' + base_architecture + '/' + str(args.iid) + '/'+str(start_time) + '/' + 'NonFedBABU_KD_Noncayley'
    ...
    log_directory = f"checkpoints/{str(args.iid)}/'NonFedBABU_KD_NonCayley'/{start_time+'without augmented dataset'}/"
