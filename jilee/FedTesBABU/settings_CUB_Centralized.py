...
parser.add_argument('--glob', action='store_true', help="GM mode: aggregate all layers (default: PM mode)")
parser.add_argument('--warmup_ep', type=int, default=0, help="Warm-up epochs for round 0 (0 → falls back to 5)")
parser.add_argument('--num_users', type=int, default=8, help="number of users")
parser.add_argument('--server_id_size', type=int, default = 2000, help="server_id size")
